...
public class SavedNewsAdapter extends RecyclerView.Adapter<SavedNewsAdapter.SavedNewsViewHolder>{
    ...
    // 1. Supporting data:
    //add the supporting data. In our case, it’s a list of Articles.
    ...
    // 2. Adapter overrides:
    // add the three essential functions for an adapter. First let’s make SavedNewsAdapter extends
    @NonNull
    @Override
    ...
    // add a SavedNewsViewHolder as an inner class.It’s for holding the view references.
